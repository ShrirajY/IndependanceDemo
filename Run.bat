...
cl.exe /c /EHsc core/Rugved/RSD_BINE/Programs/objects.cpp			/I external\freeglut\include /I include /I core\Rugved\RSD_BINE\Programs /I.
...
link.exe main.obj Utils.obj shapes.obj objects.obj cholaTemple.obj  /LIBPATH:external\freeglut\lib\x64 freeglut.lib /SUBSYSTEM:CONSOLE
main.exe