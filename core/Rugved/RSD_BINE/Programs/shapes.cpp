...
void drawQuad_RD(float x, float y, float tx, float ty, float r, float g, float b)
{
	glBegin(GL_TRIANGLE_STRIP);
	glColor3f(r, g, b);
...
void drawCircle_RD(float rad, float tx, float ty, float r, float g, float b)
{
...
void drawRASTriangle(float x, float y, float tx, float ty, float scale, float r, float g, float b)
{
	glBegin(GL_TRIANGLES);
	glColor3f(r, g, b);
	glVertex2f( x + 0.001f + tx * scale,  y + ty * scale);
	glVertex2f(-x          + tx * scale, -y + ty * scale);
	glVertex2f( x          + tx * scale, -y + ty * scale);
	glEnd();
}
...
{
	drawCircle_RD(0.05f, x +  0.0f  , y + 0.0f , 0.08f, 0.21f, 0.02f);
	drawCircle_RD(0.05f, x +  0.055f, y + 0.0f , 0.08f, 0.21f, 0.02f);
	drawCircle_RD(0.05f, x -  0.055f, y + 0.0f , 0.08f, 0.21f, 0.02f);
	drawCircle_RD(0.05f, x +  0.0f  , y + 0.05f, 0.08f, 0.21f, 0.02f);
	drawCircle_RD(0.05f, x +  0.0f  , y - 0.05f, 0.08f, 0.21f, 0.02f);
}
